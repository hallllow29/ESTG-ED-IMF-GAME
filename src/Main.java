...
public class Main {
	...
	/**
	 * Displays a simulation menu to the user, allowing the selection between
	 * manual and automatic simulation modes. It continually prompts for input
	 ...
	 * - 0: Exit the program
	 * If an invalid input is received, an error message is displayed.
	 * The method loops until a valid exit condition (option 9 or 0).
	 */
