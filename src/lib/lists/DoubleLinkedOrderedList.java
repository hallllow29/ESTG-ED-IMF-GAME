...
public class DoubleLinkedOrderedList<T extends Comparable<T>> implements OrderedListADT<T> {
    ...
    /**
     * Constructs a string representation of the doubly linked ordered list.
     * The string representation consists of the elements in the list in sequential order,
     * separated by " -> ". If the list is empty, it returns "Lista vazia".
     *
     * @return a string representation of the doubly linked ordered list or "Lista vazia" if the list is empty
     */
