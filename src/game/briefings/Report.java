...
/**
 * The Report class represents a detailed record of a game simulation or mission.
 * It encapsulates information such as the mission type, player involved, mission details,
...
public class Report {
     ...
     * This variable is used to uniquely distinguish and track a specific simulation instance
     * within the context of the application. It ensures that each simulation report can
     * be accurately identified and referenced as needed.
     */
    private String simulationId;

    /**
     * Represents the timestamp associated with the report.
     * This variable holds the time at which the report was generated or updated,
     * formatted as a string.
     * It can be used to track or identify the temporal information related to the report.
     */
    private String timestamp;

    /**
     * Represents the type or category of a report in the simulation.
     * This variable is used to define and store the specific type of report,
     * providing contextual information about the nature of the report.
     * For example, it could indicate whether the report is a mission summary,
     * player status update, or an event log generated during the simulation.
     */
    private String type;

    /**
     * Represents the status of a mission associated with the report.
     * This variable stores information about the current status or outcome of the mission,
     * such as whether it is ongoing, completed successfully, or failed.
     */
    private String missionStatus;

    /**
     * Represents the player involved in the mission report.
     * This variable holds a reference to the Player object associated with the report,
     * encapsulating the player's attributes, position, inventory, and other game-related details.
     */
    private Player player;

    /**
     * Represents the mission associated with the report. A mission contains details
     * such as the battlefield, objectives, enemies, items, and entry/exit points.
     * This variable links the report to the specific mission in the context of a
     * game or simulation.
     */
    private Mission mission;

    /**
     * Represents the player's starting location or point of entry in the mission.
     * The entry point identifies the specific area or room from which the mission begins.
     * It provides context for the mission's starting situation and can be used to track
     * the player's initial position within the mission environment.
     */
    private String entryPoint;

    /**
     * Represents the size of the backpack in the context of a report.
     * This variable is used to indicate the capacity or size type of the backpack
     * associated with the player or mission in the report.
     *
    ...
    /**
     * Represents the trajectory taken by the player to reach the extraction point
     * during a mission. The trajectory is stored as an unordered list of room names
     * or waypoints traversed by the player.
     */
     ...
     * It provides a means to track and retrieve details about enemies that remained at the
     * end of the scenario represented by the {@code Report} class.
     */
    private final ArrayUnorderedList<String> enemiesSurvived;

    /**
     * A list that stores the names of enemies that were killed during a mission.
     * This field is implemented as an unordered list, allowing flexible addition
     * of enemy names in no particular order. It helps track the outcomes of a mission
     * and provides insights into the player's interactions with enemies.
     */
    private final ArrayUnorderedList<String> enemiesKilled;

    /**
     * Constructs a new Report instance with the specified type, player, and mission.
     * This constructor initializes the report with a unique simulation ID, a timestamp,
     * and references to the player and mission involved. It also initializes
     * several collections to track various aspects of the mission such as
     * trajectory paths and enemy states.
     *
    ...
    /**
     * Updates the size of the backpack based on the provided value.
     * The backpack size is represented as a descriptive string corresponding
     * to the given integer value.
     *
     * @param backPackSize an integer representing the backpack size.
     *                     Acceptable values are:
     *                     0 - "Try hard mode (No backpack)"
     *                     1 - "Small Backpack"
     *                     2 - "Medium Backpack"
     *                     5 - "Big Backpack"
     *                     Any other value results in "No backPack used".
     */
     ...
     *
     * @param timestamp a string representing the timestamp to be set.
     *                  The timestamp typically indicates when the report was created or updated.
     */
    ...
    /**
     * Sets the type of the report. The type specifies the category or context of the report,
     * such as simulation, mission result, or other relevant types.
     *
     ...
     *
     * @return an ArrayUnorderedList of strings, where each string represents
     *         a step or location in the trajectory path to the target.
     */
     ...
     *
     * @return an ArrayUnorderedList of strings, where each string represents
     *         the name of an enemy that survived the mission.
     */
     ...
     *
     * @return an ArrayUnorderedList of strings, where each string represents
     *         a step or location in the trajectory path to the extraction point.
     */
    ...
    /**
     * Retrieves the current timestamp in the format "yyyy-MM-dd'T'HH:mm:ss".
     * The timestamp represents the current date and time when the method is called.
     *
     ...
     *
     * @return an ArrayUnorderedList of strings, where each string represents
     *         the name of an enemy that was eliminated.
     */
